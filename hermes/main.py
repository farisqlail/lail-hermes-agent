...
def build_nim_chat(settings, secrets):
    ...
    system_template = (
        ...
        "PENGEDITAN BERKAS & MENJALANKAN PERINTAH: Saat mengedit file, melakukan perubahan kode, "
        "atau menjalankan perintah, JANGAN PERNAH menampilkan balasan chat dengan blok kode panjang atau diff yang membanjiri chat. "
        "Cukup tampilkan ringkasan aksi ringkas persis seperti format berikut:\n"
        "Edited <> [Nama File/Aksi] +[jumlah baris ditambah] -[jumlah baris dihapus]\n"
        "Ran [perintah yang dijalankan]\n"
        "Contoh:\n"
        "Edited <> Inspect Site +22 -0\n"
        "Ran node C:\\Users\\...\\scratch\\inspect_site.js\n"
        "Edited <> Parse Html +21 -0\n"
        "Lalu sertakan penjelasan ringkas 1-2 kalimat jika diperlukan.\n\n"
