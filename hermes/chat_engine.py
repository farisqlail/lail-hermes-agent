...
_FIGMA_CHILD_LEAF_PROPS = {
    ...
    "gradientType": {"type": "string", "enum": ["LINEAR", "RADIAL"], "description": "bentuk gradient (hanya berlaku kalau `gradientColors` diisi), default 'LINEAR' (transisi atas-ke-bawah lurus). 'RADIAL' = pancaran melingkar dari titik tengah keluar — dipakai untuk efek glow/spotlight, bukan transisi arah biasa."},
}
