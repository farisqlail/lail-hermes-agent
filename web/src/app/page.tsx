...
export default function Home() {
  ...
  if (!mounted) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#0b0c10', color: '#66fcf1', fontFamily: 'monospace' }}>
        LOADING LAIL HERMES INTERFACE...
      </div>
    );
  }
