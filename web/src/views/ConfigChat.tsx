  ...
  return (
    <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div>
        ...
        <p className="settings-panel-desc">Konfigurasi nama identitas asisten, kreativitas respons obrolan, dan sinkronisasi kalender.</p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
        ...
        <Field label="Google Calendar iCal URL" helpText="Alamat rahasia format iCal untuk integrasi agenda">
          <input
            type="text"
            className="field-input"
